        ...
        <div class="search-filters">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2 col-6">
                    <select class="form-select filter-select" id="Selectmodelo" name="Selectmodelo">
                ...
                <div class="col-md-2 col-6">
                    <select class="form-select filter-select" id="agno_inicio" name="agno_inicio">
                        <option selected value="0">Año inicio</option>
                    <?php
                    for ($anio = 2026; $anio >= 1960; $anio--) {
                    ...
                    <select class="form-select filter-select" id="agno_fin" name="agno_fin">
                        <option selected value="0">Año Fin</option>
                                            <?php
                    for ($anio = 2026; $anio >= 1960; $anio--) {
                        echo '<option value="' . $anio . '">' . $anio . '</option>';
                    }
            ...
            <div class="results-count mt-3">
                Mostrando <?php echo count($vehiculos); ?> resultados.
            </div>
            </form>
        </div>
    </div>
